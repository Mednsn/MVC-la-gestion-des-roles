...
<body class="min-h-screen relative bg-gray-900 text-white">
  ...
  <div class="absolute inset-0 z-0">
    <img src="assets/images/stree.jpg" alt="Background" class="w-full h-45 bg-cover">
  ...
  <div class="relative z-10 max-w-7xl mx-auto px-8 py-16">
    ...
    <header class="flex justify-between items-center mb-16">
      ...
      <nav class="space-x-6">
        ...
        <a href="/signeUp" class="px-4 py-2  rounded-xl text-primary font-semibold hover:bg-primary hover:text-white transition">Signe Up</a>
        <a href="/login" class="px-4 py-2 rounded-xl bg-gradient-to-r from-primary to-secondary text-white font-semibold
               hover:from-secondary hover:to-accent transition">Login</a>
      </nav>
    </header>
    ...
    <section id="hero" class="text-center py-24">
      ...
      <a href="/login" class="bg-gray-800/80 text-white px-8 py-4 rounded-xl font-bold hover:bg-gray-700 transition">Commencer</a>
    </section>
    ...
    <section class="text-center py-16">
      <a href="/login" class="bg-gray-800/80 text-white px-10 py-4 rounded-xl font-bold hover:bg-gray-700 transition">Se connecter</a>
    </section>
